...
type AuthServiceClient interface {
	...
	DeleteUser(ctx context.Context, in *EntityID, opts ...grpc.CallOption) (*DeleteResponse, error)
}
...
func (c *authServiceClient) DeleteUser(ctx context.Context, in *EntityID, opts ...grpc.CallOption) (*DeleteResponse, error) {
...
type AuthServiceServer interface {
	...
	DeleteUser(context.Context, *EntityID) (*DeleteResponse, error)
}
...
func _AuthService_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).DeleteUser(ctx, req.(*EntityID))
	}
	return interceptor(ctx, in, info, handler)
}
